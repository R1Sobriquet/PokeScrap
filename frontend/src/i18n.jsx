...
const DICT = {
  fr: {
    ...
    "restock.subtitle":
      "Surveillance polie du scellé. Une transition de stock déclenche une alerte unique Discord + Telegram. Le radar signale — il n'achète pas.",
  ...
  en: {
    ...
    "restock.subtitle":
      "Polite retail surveillance of sealed product. A stock transition fires a single Discord + Telegram alert. The radar signals — it never buys.",
    "restock.retailers": "CULTURA · FNAC · MICROMANIA",
